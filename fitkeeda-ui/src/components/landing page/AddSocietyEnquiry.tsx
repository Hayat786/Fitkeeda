...
export default function SocietyEnquiryForm() {
  ...
  const steps = ["Basic Info", "Amenities", "Confirm"];
  ...
  return (
    <div className="min-h-screen lg:h-screen gradient-bg flex flex-col lg:flex-row items-center justify-center p-6 gap-8 lg:gap-12 relative">
      ...
      <button
        onClick={() => router.push("/")}
        className="absolute top-4 left-4 flex items-center gap-2 bg-white/90 backdrop-blur-md border border-gray-200 shadow-md px-4 py-2 rounded-2xl text-blue-600 text-lg font-semibold hover:bg-blue-50 hover:text-blue-700 hover:scale-105 transition-transform duration-300 z-10"
      >
        ...
        {step === 0 && (
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl lg:text-3xl font-bold text-black flex items-center justify-center gap-2">
                <FaBuilding className="text-blue-600 text-xl" />
                Basic Info
              </h2>
              <p className="text-gray-700 text-base lg:text-lg mt-1">
                Enter your society’s basic information including location
              </p>
            </div>
        ...
        {step === 1 && (
          <div className="space-y-5">
            <div className="text-center">
              ...
              <p className="text-gray-700 text-base lg:text-lg mt-1">
                Add the amenities available in your society
              </p>
            </div>
  ...
  <span className="text-2xl lg:text-3xl font-bold text-black tracking-wide">
    Confirm Details
  </span>
</h2>
