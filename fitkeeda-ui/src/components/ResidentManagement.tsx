...
export default function ResidentFunctions() {
  ...
  const residentFunctions: FunctionCardProps[] = [
    ...
    },
    {
      ...
      caption: "Schedule new sessions for any society",
      gradient: "from-green-400 to-teal-500",
      action: () => router.push("/admin/resident/sessions"),
    },
    {
      title: "Send Notices",
    ...
    },
    {
      ...
      caption: "See all societies with subscriptions",
      gradient: "from-teal-400 to-green-500",
      action: () => router.push("/registered-societies-placeholder"),
    },
  ];
